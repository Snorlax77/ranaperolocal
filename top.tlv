         ...
         /frog
            \viz_js
               ...
               init() {
                 ...
                 let imgURL = "https://raw.githubusercontent.com/stevehoover/makerchip_examples/master/viz_imgs/frog.png"
                 // Image
                 ret.img = this.newImageFromURL(imgURL, {crossOrigin: 'anonymous', left: 10, top: 20, width: 20})
                 return ret
               },
               render() {
                  //debugger
